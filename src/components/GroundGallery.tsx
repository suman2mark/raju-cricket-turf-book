    ...
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">{translate('facility_title') || 'Our Cricket Facility'}</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            {translate('facility_subtitle') || 'Experience premium cricket at Raju Sixer Adda with our well-maintained grounds, perfect for day and night matches.'}
          </p>
        </div>
